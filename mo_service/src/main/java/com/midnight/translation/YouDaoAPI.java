package com.midnight.translation;
...
public class YouDaoAPI {
    ...
    public static String getTranslation(String word){
        ...
        /** 处理结果 */
        try {
            json = YouDaoAPI.requestForHttp(YOUDAO_URL, params);
            ObjectMapper mapper = new ObjectMapper();
            explains = mapper.readTree(json).get("basic").get("explains").elements().next().asText();
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static String requestForHttp(String url,Map<String,String> params) throws IOException {
        ...
        var paramsList = new ArrayList<NameValuePair>();
